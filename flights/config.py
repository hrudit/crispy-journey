...
FLIGHTS_ROOT = pathlib.Path(__file__).resolve().parent.parent
UPLOAD_FOLDER = FLIGHTS_ROOT/'var'/'uploads'
...
# Database file is var/flights.sqlite3
DATABASE_FILENAME = FLIGHTS_ROOT/'var'/'flights.sqlite3'